                                ...
                                <tbody>
                                    @foreach ($alunos as $aluno)
                                        <tr>
                                            ...
                                            <form method="GET">
                                                @csrf
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#confirmModal{{ $aluno->id }}"
                                                    style="display: flex; align-items: center; background: none; border: none; color: #BB2D3B; font-weight: 500">
                                                    <span>Deletar</span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="#BB2D3B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-unlink" style="margin-left: 10px;">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <path d="M17 22v-2" />
                                                        <path d="M9 15l6 -6" />
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="confirmModal{{ $aluno->id }}" tabindex="-1" aria-labelledby="confirmModalLabel"
                                                aria-hidden="true">

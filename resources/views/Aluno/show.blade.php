                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        @if ($ultimaMedida)
                            <td>
                                @php
                                    $diferencaBracoDireito = $medidaCorporal->braco_direito - $ultimaMedida['braco_direito'];
                                @endphp
                    ...
                    <tr>
                        ...
                        @if ($ultimaMedida)
                            <td>
                                @php
                                    $diferencaBracoEsquerdo = $medidaCorporal->braco_esquerdo - $ultimaMedida['braco_esquerdo'];
                                @endphp
                    ...
                    <tr>
                        ...
                        @if ($ultimaMedida)
                            <td>
                                @php
                                    $diferencaCoxaDireita = $medidaCorporal->coxa_direita - $ultimaMedida['coxa_direita'];
                                @endphp
                    ...
                    <tr>
                        ...
                        @if ($ultimaMedida)
                            <td>
                                @php
                                    $diferencaCoxaEsquerda = $medidaCorporal->coxa_esquerda - $ultimaMedida['coxa_esquerda'];
                                @endphp
